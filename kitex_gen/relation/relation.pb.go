...
func (x *DouyinRelationFriendListResponse) GetUserList() []*user.User {
	if x != nil {
		return x.UserList
	}
	return nil
...
var file_idl_relation_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x24, 0x64, 0x6f, 0x75, 0x79,
	...
	0x73, 0x67, 0x88, 0x01, 0x01, 0x12, 0x27, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69,
	...
	0x0a, 0x0b, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6d, 0x73, 0x67, 0x32, 0xe1, 0x03,
...
var file_idl_relation_proto_depIdxs = []int32{
	8, // 0: relation.douyin_relation_follow_list_response.user_list:type_name -> user.User
	8, // 1: relation.douyin_relation_follower_list_response.user_list:type_name -> user.User
	8, // 2: relation.douyin_relation_friend_list_response.user_list:type_name -> user.User
