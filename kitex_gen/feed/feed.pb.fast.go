...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_DouyinGetVideosByVideoIdsAndCurrentUserIdRequest[number], err)
}

func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}

func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) fastReadField2(buf []byte, _type int8) (offset int, err error) {
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_DouyinGetVideosByVideoIdsAndCurrentUserIdResponse[number], err)
}

func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.StatusCode, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	tmp, offset, err := fastpb.ReadString(buf, _type)
	x.StatusMsg = &tmp
	return offset, err
}

func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	var v Video
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) fastWriteField2(buf []byte) (offset int) {
	if len(x.VideoIds) == 0 {
		return offset
	}
	offset += fastpb.WriteListPacked(buf[offset:], 2, len(x.VideoIds),
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastWriteField1(buf []byte) (offset int) {
	if x.StatusCode == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 1, x.StatusCode)
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastWriteField2(buf []byte) (offset int) {
	if x.StatusMsg == nil {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, *x.StatusMsg)
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) fastWriteField3(buf []byte) (offset int) {
	if x.VideoList == nil {
		return offset
	}
	for i := range x.VideoList {
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) sizeField1() (n int) {
	if x.UserId == 0 {
		return n
	}
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdRequest) sizeField2() (n int) {
	if len(x.VideoIds) == 0 {
		return n
	}
	n += fastpb.SizeListPacked(2, len(x.VideoIds),
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) sizeField1() (n int) {
	if x.StatusCode == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.StatusCode)
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) sizeField2() (n int) {
	if x.StatusMsg == nil {
		return n
	}
	n += fastpb.SizeString(2, *x.StatusMsg)
...
func (x *DouyinGetVideosByVideoIdsAndCurrentUserIdResponse) sizeField3() (n int) {
	if x.VideoList == nil {
		return n
	}
	for i := range x.VideoList {
...
var fieldIDToName_DouyinGetVideosByVideoIdsAndCurrentUserIdRequest = map[int32]string{
	1: "UserId",
	2: "VideoIds",
}

var fieldIDToName_DouyinGetVideosByVideoIdsAndCurrentUserIdResponse = map[int32]string{
	1: "StatusCode",
	2: "StatusMsg",
	3: "VideoList",
}
